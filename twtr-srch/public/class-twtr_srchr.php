...
/**
 * Twtr_Srchr class. This class should ideally be used to work with the
 * public-facing side of the WordPress site.
 *
 * If you're interested in introducing administrative or dashboard
 * functionality, then refer to `class-twtr_srchr-admin.php`
 *
 * @package Twtr_Srchr
 * @author  Mark Hayden <hi@markhayden.me>
 */
class Twtr_Srchr {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'twtr_srchr';
	...
	public static function activate( $network_wide ) {
		...
		$sql = "CREATE TABLE `".$table_name."` (
			...
			`twtr_name` varchar(150) NOT NULL,
			`twtr_handle` varchar(100) NOT NULL,
			`twtr_content` text NOT NULL,
			`twtr_posted` date NOT NULL,
			`twtr_url` text NOT NULL,
			`logged` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
			UNIQUE KEY `id` (`id`),
			UNIQUE KEY `twtr_id` (`twtr_id`),
			PRIMARY KEY `id` (`id`)
		);";
		...
		add_option( "twtr_db_version", $twtr_db_version );
		add_option( "twtr_api_key", null );
